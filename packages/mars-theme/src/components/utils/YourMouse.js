...
const Cursor = styled.div`
  ...
  div {
    ...
    -webkit-transition: height .25s ease-in-out, width .25s ease-in-out, transform 0.25s ease-in-out, opacity 0.35s ease;
    transition: height .25s ease-in-out, width .25s ease-in-out, transform 0.25s ease-in-out, opacity 0.35s ease;
  }
